...
module.exports = async function(opts) {
  ...
  try {
    ...
    let context = {
      ...
      insomniaIds: generateInsomniaIds(65) // this magic number is the length of 'resources' array in 'insomnia-workspace.json'
    };
    ...
    if (preferParentDir) {
      [".editorconfig", "README.md", "gitignore"].forEach(item => {
...
function generateInsomniaIds(amount) {
  let result = [];
  for (let i = 0; i < amount; i++) {
    result.push(crypto.randomBytes(32).toString("hex"));
  }
  return result;
}
