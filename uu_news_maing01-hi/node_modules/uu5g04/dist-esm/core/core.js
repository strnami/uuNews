 ...
 */
import "./polyfills.js";
import React from "react"; // startup environment (merge)

import "./startup-environment.js";

if (!React.lazy || !React.Suspense) {
  console.warn(`For full functionality of ${"uu5g04"} use React version >= 16.6.0. In-page React version: ${React.version}`);
}
