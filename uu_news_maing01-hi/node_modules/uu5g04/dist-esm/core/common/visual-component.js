...
import { SYMBOL_COMPONENT, SYMBOL_INIT, SYMBOL_GUARD } from "./component-symbols"; //@@viewOff:imports
...
export class VisualComponent {
  ...
  static create(componentDescriptor) {
    return doCreate(componentDescriptor); // TODO Optimization is temporarily disabled, until it gets fully tested.
...
function addBasicVisualPropsPreprocessor(componentDescriptor) {
  let {
    mixins,
    propTypes
  } = componentDescriptor; // add standard visual props if no mixin is used

  if (!mixins || mixins.length === 0) {
    if (typeof propTypes !== "function") {
      componentDescriptor.propTypes = { ...VisualComponent.propTypes,
        ...propTypes
      };
      ...
      if (componentDescriptor.defaultProps) {
        ...
        componentDescriptor.getDefaultProps = function () {
          ...
          return { ...VisualComponent.defaultProps,
            ...result
          };
        };
      } else {
