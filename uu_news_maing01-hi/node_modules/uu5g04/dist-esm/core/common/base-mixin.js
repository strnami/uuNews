...
export const BaseMixin = {
  ...
  propTypes: {
    ...
    ref_: PropTypes.oneOfType([PropTypes.func, PropTypes.shape({
  ...
  getInitialState: function () {
    ...
    this.id = this.props.id === null ? Tools.generateUUID() : this.props.id; // state
  ...
  getLsiComponent(item, mixin, params) {
    return Tools.findComponent("UU5.Bricks.Lsi", {
