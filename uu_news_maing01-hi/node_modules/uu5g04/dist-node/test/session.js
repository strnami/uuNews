  ...
  _createClass(MockSession, [{
    ...
    value: function mockSetPending() {
      ...
      this.initPromise = new Promise(function (resolve, reject) {
        _this._initPromiseResolve = resolve;
        _this._initPromiseReject = reject;
      });
      this._identity = null;
...
var Session = {
  ...
  setIdentity: function () {
    var _setIdentity = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(identity) {
