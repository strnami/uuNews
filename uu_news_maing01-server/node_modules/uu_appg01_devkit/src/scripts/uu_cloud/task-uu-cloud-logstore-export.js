  ...
  async _getExport() {
    ...
    while (true) {
      ...
      if (partialResult.totalSize < maxPageSize) {
        ...
        to = partialResult.pageEntries[maxPageSize - 1].time; // sometimes partial result might contain 1001 entries - use the 1000th entry as partial query param because the 10001th is last log of the whole query (problem in logstore service).
