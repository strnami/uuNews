...
const AppClientService = {
  UC_CODE: `${WorkspaceError.ERROR_PREFIX}sysAppClient/`,
...
const ListKeys = {
  UC_CODE: `${WorkspaceError.ERROR_PREFIX}sysAppClientTokenListKeys/`,
...
const GetPrivateKey = {
  UC_CODE: `${WorkspaceError.ERROR_PREFIX}sysAppClientTokenGetPrivateKey/`,
  KeysNotInitialized: class extends WorkspaceError {
    constructor() {
      super(...arguments);
