...
const { InvalidDeploymentConfigError, FileNotFoundError, InvalidKeyError } = require("../errors/startup-errors.js");

const APP_FOLDER = "app";
const DEFAULT_CONFIG_FOLDER = "config";
const VALIDATION_TYPES_RELATIVE_PATH = "../validation_types/config-types.js";
